...
function Footer() {
    ...
    <div className="p-5">
      <ul>
        ...
        <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-700 cursor-pointer">Hospital Search</li>
        <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-700 cursor-pointer">Blog Post</li>
      </ul>
    </div>
    <div className="p-5">
        <ul>
            <p className="text-gray-800 font-bold text-2xl pb-4">Company</p>
            <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-700 cursor-pointer">About</li>
            <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-700 cursor-pointer">Contact</li>
            <li className="text-gray-500 text-md pb-2 font-semibold hover:text-blue-700 cursor-pointer">Admin Login</li>
        </ul>
    </div>
    <div className="p-5">
      <ul>
